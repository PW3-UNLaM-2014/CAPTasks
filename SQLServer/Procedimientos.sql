...
IF EXISTS (SELECT * FROM sysobjects WHERE name='p_ListarTareasPorCarpeta')
BEGIN
DROP PROCEDURE [dbo].[p_ListarTareasPorCarpeta]
END
GO

CREATE PROCEDURE [dbo].[p_ListarTareasPorCarpeta] 
	@CARPETAID int
AS
BEGIN
