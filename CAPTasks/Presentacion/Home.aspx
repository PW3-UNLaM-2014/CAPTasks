    ...
    <div class="col-md-12">
        ...
        <div id="page-wrapper" class="col-md-9">
            ...
            <asp:GridView ID="gvListaTareas" runat="server" AutoGenerateColumns="False" ForeColor="#333333"
                GridLines="None" CellPadding="10" CellSpacing="4" DataKeyNames="IdTarea" OnRowDataBound="gvListaTareas_RowDataBound">
                <AlternatingRowStyle BackColor="White" />
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Accion" ShowHeader="False">
                        <ItemTemplate>
                            <asp:Button ID="btnCompletar" runat="server" CausesValidation="false" CommandName="Update"
                ...
                <EditRowStyle BackColor="#2461BF" />
                <FooterStyle BackColor="#507CD1" Font-Bold="True" ForeColor="White" />
                <HeaderStyle BackColor="#507CD1" Font-Bold="True" ForeColor="White" Width="400" VerticalAlign="Middle"
